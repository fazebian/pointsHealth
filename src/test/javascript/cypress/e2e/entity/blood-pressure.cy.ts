...
describe('BloodPressure e2e test', () => {
  ...
  const bloodPressureSample = { timestamp: '2023-06-20T04:02:38.606Z', systolic: 27476, diastolic: 27392 };
  ...
  describe('new BloodPressure page', () => {
    ...
    it('should create an instance of BloodPressure', () => {
      cy.get(`[data-cy="timestamp"]`).type('2023-06-19T15:37').blur().should('have.value', '2023-06-19T15:37');
