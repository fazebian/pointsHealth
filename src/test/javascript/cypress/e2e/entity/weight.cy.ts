...
describe('Weight e2e test', () => {
  ...
  const weightSample = { timestamp: '2023-06-19T20:06:23.808Z', weight: 1792 };
  ...
  describe('new Weight page', () => {
    ...
    it('should create an instance of Weight', () => {
      cy.get(`[data-cy="timestamp"]`).type('2023-06-19T13:54').blur().should('have.value', '2023-06-19T13:54');
